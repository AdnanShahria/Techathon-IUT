...
import { ShieldAlert, Flame, Wind } from 'lucide-react';
...
export default function SensorActivityTest() {
  ...
  // Send update to API whenever slider values change (debounced slightly to avoid spam)
  useEffect(() => {
  ...
  return (
    <div className="sensor-test-section" style={{ gridColumn: '1 / -1', marginTop: '1rem' }}>
      ...
      <div className="sensor-test-card" style={{ background: 'var(--bg-card)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--border-subtle)', display: 'flex', flexWrap: 'wrap', gap: '2rem', alignItems: 'center' }}>
